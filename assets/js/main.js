(function () {
  ...
  function closeNav(returnFocus) {
    ...
    if (returnFocus) navMenu.querySelector("summary").focus();
  }
  ...
  if (navMenu && nav) {
    ...
    document.addEventListener("click", function (event) {
      if (navMenu.hasAttribute("open") && !event.target.closest(".site-nav")) closeNav(false);
    });
  ...
  function openTooltip(trigger) {
    ...
    tooltip.textContent = trigger.getAttribute("data-definition") || trigger.getAttribute("data-tooltip");
  ...
  document.querySelectorAll("[data-tooltip], [data-definition]").forEach(function (trigger) {
  ...
  document.documentElement.classList.add("tooltips-ready");

  document.addEventListener("click", closeTooltip);
  document.addEventListener("keydown", function (event) {
    if (event.key === "Escape") {
      closeTooltip();
      if (navMenu && navMenu.hasAttribute("open")) closeNav(true);
    }
  });
